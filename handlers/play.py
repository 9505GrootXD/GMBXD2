...
async def play(_, message: Message):
    ...
    lel = await message.reply("🔎 **పాటను వెతుకుతున్న...😒**")
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                try:
                    ...
                    await lel.edit(
                        "<b>ని గ్రూప్ లో ఆడ్ చేసి నాకు అడ్మిన్ ఇవ్వు 😏</b>")
                    return
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>𝗙𝗹𝗼𝗼𝗱 𝗪𝗮𝗶𝘁 𝗘𝗿𝗿𝗼𝗿 </b>\n𝗛𝗲𝘆 𝗕𝗮𝗯𝘂! 😒 𝗔𝘀𝘀𝗶𝘀𝘁𝗮𝗻𝘁 𝗨𝘀𝗲𝗿𝗕𝗼𝘁 𝗖𝗼𝘂𝗹𝗱𝗻'𝘁 𝗝𝗼𝗶𝗻 𝗬𝗼𝘂𝗿 𝗚𝗿𝗼𝘂𝗽 𝗗𝘂𝗲 𝗧𝗼 𝗛𝗲𝗮𝘃𝘆 𝗝𝗼𝗶𝗻 𝗥𝗲𝗾𝘂𝗲𝘀𝘁 . 𝗠𝗮𝗸𝗲 𝗦𝘂𝗿𝗲 𝗨𝘀𝗲𝗿𝗕𝗼𝘁 𝗜𝘀 𝗡𝗼𝘁 𝗕𝗮𝗻𝗻𝗲𝗱 𝗜𝗻 𝗚𝗿𝗼𝘂𝗽 𝗔𝗻𝗱 𝗧𝗿𝘆 𝗔𝗴𝗮𝗶𝗻 𝗟𝗮𝘁𝗲𝗿 𝗔𝗻𝘆 𝗛𝗲𝗹𝗽 𝗗𝗺:-  [❛-𝗜𝗮𝗺 𝗚𝗿𝗼𝗼𝘁 🌱](https://t.me/sarkarrobot)")
    try:
    ...
    if audio:
        if round(audio.duration / 60) > DURATION_LIMIT:
            raise DurationLimitError(
                f"**ఒక పాట {DURATION_LIMIT} నిముషాలు మించి ఉండకూడదు, ఎక్కువ నిముషాలు ఉన్న పాట ను ప్లే చేయలేను😇**"
            )
        ...
        try:
            ...
            await lel.edit(
                "**పాట దొరకడం లేదు సర్రిగా టైప్ చై 😒**"
            )
            print(str(e))
            return
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        await message.reply_photo(
            photo="final.png",
            caption="****🌱 𝗚𝗿𝗼𝗼𝘁 𝗠𝘂𝘀𝗶𝗰 𝗦𝗼𝗻𝗴 𝗣𝗼𝘀𝗶𝘁𝗶𝗼𝗻** {}**".format(position),
